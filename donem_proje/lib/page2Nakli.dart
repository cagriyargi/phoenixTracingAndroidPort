                ...
                children: [
                  Card(
                    child: ListTile(
                      ...
                      title: Text("Login Sayfasına Dön"),
                      subtitle: Text(
                  ...
                  Card(
                    child: ListTile(
                      ...
                      subtitle: Text("Sayfayı tekrar yüklemek için"),
                      onTap: () {
                  ...
                  Card(
                    child: ListTile(
                      ...
                      subtitle: Text(
                          "Kullanıcının ayrıntılı bilgilerini görmek için"),
                      onTap: () {
                  ...
                  Card(
                    child: ListTile(
                      ...
                      subtitle: Text("Destek talebi oluşturmak için"),
                      onTap: () {
                  ...
                  Card(
                    child: ListTile(
                      ...
                      subtitle: Text(
                          "Daha önceden oluşturulmuş destek taleplerini görüntülemek için"),
                      onTap: () {
