    ...
    */
    public function select()
    {
        ...
        if($con != null)
        {
            $job_id=$_POST['job_id'];
            $userid=$_POST['userid'];
            $SQL_SELECT_ALL="SELECT * FROM `periodic_jobs`WHERE job_id='".$job_id."' AND technician_id='".$userid."'";
